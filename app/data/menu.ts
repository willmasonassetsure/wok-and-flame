...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken in Szechuan Sauce", price: "7.80", spicy: true },
      ...
      { name: "Chicken in Lemon Honey Sauce", price: "7.80" },
      { name: "Beef in Sweet Cantonese Sauce", price: "7.80" },
      {
  ...
  },
  {
    ...
    items: [
      { name: "Crispy Shredded Beef", price: "7.80", popular: true },
