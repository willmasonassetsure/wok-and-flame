 ...
 * routes: (1) Order Direct — highlighted, pushes the phone line + the active
 * discount because every direct order skips the ~30% delivery-app commission;
 ...
 * from app/lib/review-stats.ts — so the whole promo can be reworded or swapped
...
export default function OrderChoiceModal({
  ...
  const directBlurb = DIRECT_OFFER_ACTIVE
    ? ORDER_MODAL.directBlurbActive
    : ORDER_MODAL.directBlurbInactive;
            ...
            <div className="wf-ember-card mt-5 rounded-2xl">
              <div className="relative rounded-2xl overflow-hidden bg-char-900 p-5">
                <div className="flex items-start justify-between gap-3">
                  ...
                  {DIRECT_OFFER_ACTIVE && (
                    <span className="shrink-0 px-2.5 py-1 rounded-full bg-vermillion text-char-50 text-[11px] font-700 tracking-wide uppercase tabular-nums shadow-[0_6px_16px_-4px_rgba(217,45,32,0.6)]">
